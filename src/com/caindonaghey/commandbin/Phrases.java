...
public class Phrases {
	...
	public static String get(String string) {
		...
		if(CommandBin.language == "dutch") {
            ...
            if(string == "players-invalid") return badPrefix + "één of meerdere spelers hiervan zijn niet online.";
            if(string == "tele-1-2") return prefix + "Speler 1 naar speler 2 geteleporteerd";
            if(string == "invalid-numbers") return badPrefix + "Invalide coördinaten ingevoerd.";
            if(string == "tele-1-co") return prefix + "Speler naar de aangegeven coördinaten geteleporteerd.";
